...
-(BOOL) UnzipFileTo:(NSString*) path overWrite:(BOOL) overwrite
{
	...
	do{
        ...
        //NSStringEncoding enc = CFStringConvertEncodingToNSStringEncoding(stringWithUTF8String);
        ...
        FILE* fp = fopen( (const char*)[fullPath cStringUsingEncoding:NSUTF8StringEncoding], "wb");
		//FILE* fp = fopen( (const char*)[fullPath NSUTF8StringEncoding], "wb");
		while( fp )
		{
