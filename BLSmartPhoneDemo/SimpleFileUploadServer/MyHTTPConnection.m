...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
	...
	if( [method isEqualToString:@"GET"] && [path hasPrefix:@"/upload/"] ) {
		...
		return [[HTTPFileResponse alloc] initWithFilePath: [path stringByAppendingString:path] forConnection:self];
	}
...
- (void) processEndOfPartWithHeader:(MultipartMessageHeader*) header
{
	...
	[storeFile closeFile];
	storeFile = nil;
    NSDictionary *notification = [[NSDictionary alloc] initWithObjectsAndKeys:uploadFileName, @"FileName", nil];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"HTTPServerFileTransmitDone" object:nil userInfo:notification];
}
